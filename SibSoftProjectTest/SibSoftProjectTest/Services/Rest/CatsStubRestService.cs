...
namespace SibSoftProjectTest.Services.Rest
{
    public class CatsStubRestService : ICatsData
    {
        public async Task<List<ImageModel>> GetCats()
        {
            ...
            {
                new ImageModel(id++, "Cats", "Cats: Adoption, Bringing A Cat Home and Care", "https://www.petfinder.com/wp-content/uploads/2013/09/cat-black-superstitious-fcs-cat-myths-162286659.jpg"),
                new ImageModel(id++, "Persian Cats And Kittens", "Cats", "http://tenthlifecats.org/mm/images/featured-cat/chaos-kittens-2.jpg"),
